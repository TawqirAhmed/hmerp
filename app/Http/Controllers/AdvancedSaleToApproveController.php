...
class AdvancedSaleToApproveController extends Controller
{
	public function index(Request $request)
    {

		if ($request->ajax()) {
		$data = DB::table('advancedsalestoapprove')
		    	->join('customers','advancedsalestoapprove.id_customer','customers.id')
		    	->select('customers.c_name','customers.c_code','advancedsalestoapprove.*')
		    	->get();
		...
		return view('inventory.advancedSalesToApprove');
    }

    public function edit($id)
	{
		$where = array('id' => $id);
		$product = DB::table('advancedsalestoapprove')->where($where)->first();
	...
	public function print(Request $request)
	{
		...
		$information =DB::table('advancedsalestoapprove')->where('id',$request->id)->first();
	    ...
	    $customer = DB::table('customers')->where('id',$customer_id)->first();
		  ...
		  $invoice->setType("Unapproved Adv. Sale Record");    // Invoice Type
	...
	{
		$pr = DB::table('advancedsalestoapprove')->where('id',$id)->delete();
		return Response::json($product);
	}
    //--------------------------------------------------------------------------------------------------
}
