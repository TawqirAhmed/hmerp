...
class QuotationPercentController extends Controller
{
	public function index(Request $request)
	{
		Cart::destroy();
		$saleId = $request->id;
		$salestoapprove = DB::table('quotation')->where('id',$saleId)->first();
	 ...
	 //        echo "<pre>";
		...
		return view('inventory.quotationPercentage',compact('costomerid','salestoapprove','paymentDescription'));
	}

	public function clearCart()
	{
		Cart::destroy();
    	return redirect()->route('qu_salesto');
	}
   ...
   //      	echo "<pre>";
            ...
            $paymentDescription = json_decode($salestoapprove->payment_description);
            return view('inventory.quotationPercentage',compact('costomerid','salestoapprove','paymentDescription'))->with($notification);
	...
	public function ApproveSale(Request $request)
	{
		...
		//approve sale ------------------------------------------------------------------------
	        ...
	        $ApproveSale=DB::table('approvedquotation')->insert($dataSales);
	        
	        if ($ApproveSale) {
	        	$dltSalestoapprove = DB::table('quotation')->where('id',$saleId)->delete();
