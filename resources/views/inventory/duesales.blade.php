...
<h1 style="text-align: center;">DUE SALES</h1>
  ...
  <div class="container-fluid">
    <div class="card card-primary card-outline">
      <div class="card-header">
        {{-- <h3 class="card-title">Due Sales</h3> --}}
		      ...
		      <form role="form" action="{{ url('/print-as') }}" method="post" enctype="multipart/form-data"target="_blank">
		        ...
		        ======================================-->  
		          <div class="modal-header" style="background: green; color: white">
		          	<h4 class="modal-title">View Due Sale</h4>
		            <button type="button" class="close" data-dismiss="modal">&times;</button>
  	...
  	{{-- Print ST Table-------------------------------------------------------------------------------------------- --}}
		...
		<!-- Modal -->
		<div id="modaldueedit_view" class="modal fade" role="dialog">
		  <div class="modal-dialog">
		    <!-- Modal content-->
		    <div class="modal-content">
		      <form role="form" action="{{ url('/modify-sta') }}" method="post" enctype="multipart/form-data">
		      	@csrf
		        <!--=====================================
		            MODAL HEADER
		        ======================================-->  
...
/* View Sale */
$('body').on('click', '#edit-due', function () {
var sta_id = $(this).data('id');
$.get('as_info/'+sta_id+'/edit', function (data) {
$('#modaldueedit_view').modal('show');
$('#sta_id').val(data.id);
