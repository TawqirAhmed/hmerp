        ...
        <div class="container">
              ...
              <div><h5>Invoice</h5></div>
                    ...
                    <table class="table" style="width: 100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th>{{ $pro->name }}</th>
                                <th>
                                    <form  action="{{ url('/makesalescart-update/'.$pro->rowId) }}" method="post">
                                      @csrf
                                ...
                                <th><a href="{{ url('/makesalescart-remove/'.$pro->rowId) }}"><i class="fas fa-trash"></i></a></th>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>

                <form  method="post" action="{{ route('makesalesshow.invoice') }}">
                   @csrf
                   <div class="row">
                    <div class="col-md-9">
                ...
                <div class="pricing-header" style="background-color: #d4af37;">
                    ...
                    @endif
                    <a href="{{ route('makesalesclear-cart') }}" class="btn btn-danger">Clear Cart</a>
        ...
        <div class="container">
          <div><h5>Product List</h5></div>
            {{-- <div style="position: absolute;right: 50px;"> --}}
              <div>
            <form action="{{ url('makesalescart-add_barcode') }}" id="barcodeForm" method="post">
              @csrf
               <div class="row">  
