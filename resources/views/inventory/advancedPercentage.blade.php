	...
	<div class="card" style="padding: auto;">
      <div class="card-body">
        <div class="container">
              ...
              <div><h5>Advanced Sell Invoice NO: {{ $salestoapprove->bill_code }}</h5></div>
                ...
                <div class="price_card text-center">
                    <table class="table" style="width: 100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <th>
                                  <form action="{{ url('/ad_cart-updatepercentage/'.$pro->rowId) }}" method="post">
                                  @csrf
                    ...
                    <hr>
                <form  method="post" action="{{ route('ad_approve.invoice') }}">
                   @csrf
                ...
                <div class="pricing-header" style="background-color: #d4af37;">
                    ...
                    @endif
                    <a href="{{ route('ad_clear-cart') }}" class="btn btn-danger">Clear Cart</a>
