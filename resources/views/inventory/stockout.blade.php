      ...
      <div class="card-body">
        <div class="container">
              ...
              <div><h5>Invoice</h5></div>
                ...
                <form  method="post" action="{{ route('show.invoice') }}">
                   @csrf
                ...
                <div class="pricing-header" style="background-color: #d4af37;">
                    ...
                    <button type="submit" class="btn btn-info" formaction="" onclick="this.form.submit(); this.disabled=true;"> Stock Out</button>   
