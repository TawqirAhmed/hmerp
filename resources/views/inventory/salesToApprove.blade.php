...
@section('content')
	<h1 style="text-align: center;">Sales To Be Approved</h1>
  ...
  <div class="container-fluid">
    <div class="card card-primary card-outline">
      <div class="card-header">
        {{-- <h3 class="card-title">Sales To Be Approved</h3> --}}
      ...
      <div class="card-body">
		...
		<div id="modalst_view" class="modal fade" role="dialog">
		  <div class="modal-dialog">
		    ...
		    <div class="modal-content">
		      <form role="form" action="{{ url('/print-st') }}" method="post" enctype="multipart/form-data"target="_blank">
		      	@csrf
		        <!--=====================================
		            MODAL HEADER
		        ======================================-->  
		...
		<div id="modalsta_view" class="modal fade" role="dialog">
		  <div class="modal-dialog">
		    <!-- Modal content-->
		    <div class="modal-content">
		      <form role="form" action="{{ url('/approve-sta') }}" method="post" enctype="multipart/form-data">
		      	@csrf
		        <!--=====================================
		            MODAL HEADER
		        ======================================-->  
...
$.get('st_info/'+st_id+'/edit', function (data) {
...
$.get('sta_info/'+sta_id+'/edit', function (data) {
