...
@section('content')
<h1 style="text-align: center;">Quotation To Be Approved</h1>
      ...
      <div class="card-body">
		...
		<div id="modalst_view" class="modal fade" role="dialog">
		  <div class="modal-dialog">
		    ...
		    <div class="modal-content">
		      <form role="form" action="{{ url('/qu_print-st') }}" method="post" enctype="multipart/form-data"target="_blank">
		      	@csrf
		        <!--=====================================
		            MODAL HEADER
		        ======================================-->  
		...
		<div id="modalsta_view" class="modal fade" role="dialog">
		  <div class="modal-dialog">
		    <!-- Modal content-->
		    <div class="modal-content">
		      <form role="form" action="{{ url('/qu_approve-sta') }}" method="post" enctype="multipart/form-data">
		      	@csrf
		        <!--=====================================
		            MODAL HEADER
		        ======================================-->  
...
$.get('qu_st_info/'+st_id+'/edit', function (data) {
...
$.get('qu_sta_info/'+sta_id+'/edit', function (data) {
